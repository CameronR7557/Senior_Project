...
/* User Configuration */
// Timer Clock
#define TIMER_CLOCK				150000000	// 150MHz

// MOTOR 1 (PA6) - TIM3 Channel 1, DMA1 Stream 1
#define MOTOR_1_TIM             (&htim3)
#define MOTOR_1_TIM_CHANNEL     TIM_CHANNEL_1

// MOTOR 2 (PD13) - TIM4 Channel 2, DMA1 Stream 2
#define MOTOR_2_TIM             (&htim4)
#define MOTOR_2_TIM_CHANNEL     TIM_CHANNEL_2

// MOTOR 3 (PD14) - TIM4 Channel 3, DMA1 Stream 3
#define MOTOR_3_TIM             (&htim4)
#define MOTOR_3_TIM_CHANNEL     TIM_CHANNEL_3

// MOTOR 4 (PB1) - TIM3 Channel 4, DMA1 Stream 4
