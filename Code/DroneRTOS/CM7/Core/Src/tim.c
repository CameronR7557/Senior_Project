...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    hdma_tim3_ch1.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_1QUARTERFULL;
    ...
    __HAL_LINKDMA(tim_pwmHandle,hdma[TIM_DMA_ID_CC1],hdma_tim3_ch1);
    ...
    hdma_tim3_ch4.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_1QUARTERFULL;
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    /* TIM4 DMA Init */
    /* TIM4_CH2 Init */
    hdma_tim4_ch2.Instance = DMA1_Stream2;
    ...
    /* TIM4_CH3 Init */
    hdma_tim4_ch3.Instance = DMA1_Stream3;
