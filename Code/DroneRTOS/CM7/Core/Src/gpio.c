...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, CS_GYRO_Pin|CS_ACC_Pin|LD2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LD19_PWR_GPIO_Port, LD19_PWR_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = CS_GYRO_Pin|CS_ACC_Pin|LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = LD19_PWR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LD19_PWR_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = GYRO_INT_Pin|ACC_INT_Pin;
